          ...
          <div className="-mx-4 flex">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[400px] text-center">
                ...
                <Link
                 href={'/'}
                  className="inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold dark:text-white transition hover:bg-white hover:text-purple-700"
                >
                  Go To Home
                </Link>
              </div>
