...
const ProjectsCategory = () => {
  ...
  useEffect(() => {
    ...
    const fetchProjects = async () => {
      try {
        const response = await fetch('https://raw.githubusercontent.com/akash-khan-311/my-portfolio/main/public/projects.json');
    ...
    <PageTitle title={'Portfolios'}/>
     ...
     <Tabs  defaultIndex={tabIndex} onSelect={(index)=> setTabIndex(index)}>
        <TabList className="flex justify-center flex-wrap gap-5 mb-32">
          <Tab className="text-xl bg-sky-500 px-7 py-2 rounded-sm cursor-pointer hover:bg-[#f3155852] duration-150 outline-none ">ALL</Tab>
          <Tab className="text-xl bg-sky-500 px-7 py-2 rounded-sm cursor-pointer hover:bg-[#f3155852] duration-150 outline-none ">CSS</Tab>
          <Tab className="text-xl bg-sky-500 px-7 py-2 rounded-sm cursor-pointer hover:bg-[#f3155862] duration-150 outline-none ">JAVASCRIPT</Tab>
          <Tab className="text-xl bg-sky-500 px-7 py-2 rounded-sm cursor-pointer hover:bg-[#f3155862] duration-150 outline-none ">REACT JS</Tab>
          <Tab className="text-xl bg-sky-500 px-7 py-2 rounded-sm cursor-pointer hover:bg-[#f3155862] duration-150 outline-none ">NODE JS</Tab>
        </TabList>
